...
namespace WindowsApplication2
{
    ...
    public partial class Form2 : Form
    {
        ...
        private void toolStripButton10_Click(object sender, EventArgs e)
        {
            ...
            //}
            string sql = string.Format(@"select '0000000000'+Code 料号,Name +'_'+DescFlexField_PrivateDescSeg1+'_'+SPECS 品名 from CBO_ItemMaster where Name like '%{0}%' and DescFlexField_PrivateDescSeg1 = '{1}' 
